...
public class GameManager : MonoBehaviour
{
    ...
    public event EventHandler OnMapShown;
    public event EventHandler OnMapHidden;
    ...
    private void Start()
    {
        ...
        GameInput.Instance.OnMapPerformed += GameInput_OnMapPerformed;
    }

    private void GameInput_OnMapPerformed(object sender, EventArgs e)
    {
        ToggleShowMap();
    }
    ...
    public void ToggleShowMap()
    {
        ...
        if (isMapShown)
        {
            ...
            if (OnMapShown != null)
            {
                OnMapShown(this, EventArgs.Empty);
            }
        }
        else
        {
            ...
            if (OnMapHidden != null)
            {
                OnMapHidden(this, EventArgs.Empty);
            }
        }
    }
